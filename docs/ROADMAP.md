...
- **Phase 4 and later:** not started. The next phase is typed CellForge and tool execution; colony evolution remains intentionally out of scope until its declared phase.
