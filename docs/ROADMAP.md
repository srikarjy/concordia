...
- **Phase 5 and later:** not started. The next phase is qualification of one local seed-scientist runtime; colony evolution remains intentionally out of scope until Phase 6.
