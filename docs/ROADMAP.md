...
- **Phase 8–10:** in progress. Interactive workspace, protocol gating, reproducibility hardening, and a free deployment are the active release work. Real scientific validation is not complete.
